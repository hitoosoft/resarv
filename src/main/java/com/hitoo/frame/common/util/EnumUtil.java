...
public class EnumUtil {
	 ...
	 */
	public static List<HashMap<String, String>> getComboboxEnumValues(Class c)
			throws Exception {
	 ...
	 * getComboboxEnumValuesWithRoot(Class c ) throws Exception{ return
	 * getComboboxEnumValues(c, true,"全部"); }
	 */

	/**
	 * 查询enum字典，用于combobox，包括“全部”
	 */
	private static List<HashMap<String, String>> getComboboxEnumValues(Class c,
			boolean withRoot, String rootName) throws Exception {
		...
		if (c.isEnum()) {
			...
			for (Object obj : objs) {
				...
				while (it.hasNext()) {
					...
					valueTextMap = new HashMap<String, String>();
					valueTextMap.put("value", (String) code.get(objOne));
					valueTextMap.put("text", (String) codeDesc.get(objOne));
					rtnList.add(valueTextMap);
					// rtnMap.put((String)code.get(objOne),
					// codeDesc.get(objOne));
	 ...
	 * 
	 * Class c = Class.forName("com.hitoo.shbuy.common.enumdic.CUSTSTA");
	 * EnumUtil t = new EnumUtil();
	 * 
	 * 
	 * 
	 * }
