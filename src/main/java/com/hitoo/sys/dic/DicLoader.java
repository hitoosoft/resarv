...
import com.hitoo.frame.common.util.ClassFilter;
import com.hitoo.frame.common.util.ClassUtils;
import com.hitoo.frame.common.util.EnumUtil;
import com.hitoo.sys.dic.service.DicService;
...
public class DicLoader {
	...
	private Map<String, Object> loadSysDic() throws Exception {
		Map<String, Object> cacheData = new HashMap<String, Object>();
		Map<String, List<Map<String, String>>> allDicMap = dicService.queryAllDicList();//加载字典
