package com.hitoo.sys.dic.service.impl;
...
import com.hitoo.sys.dic.dao.DicDao;
...
public class DicServiceImpl extends BaseService implements DicService {
	 ...
	 */
	@Override
	public String queryDicDtlJson(String dicCod) throws Exception{
		List<DicDtl> allDtl = dicDao.queryDicDtlByDicCod(dicCod);
		if(allDtl!=null&&allDtl.size()>0){
			return  JSON.toJSONString(allDtl);
		}
		return "";
	}
