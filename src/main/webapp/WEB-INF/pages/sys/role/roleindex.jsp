	...
	<div region="west" style="width:500px;" border="false" >
		...
		<div id="tb">
			<div class="perm-panel">
			    <a class="easyui-linkbutton" id="EAMSSYS00070002" onClick="manageRoleFnc(0);" icon="icon-add" plain="true">新增</a> 
				<a class="easyui-linkbutton" id="EAMSSYS00070003" onClick="manageRoleFnc(1);" icon="icon-edit" plain="true">修改</a>
				<a class="easyui-linkbutton" id="EAMSSYS00070004" onClick="delRoleFnc();" icon="icon-remove-edit" plain="true">删除</a>
			</div>
		</div>
	</div>
	<div region="center" border="false" class="htborder-left">
		<div class="easyui-layout" fit="true">
		  <div region="center" border="false">
		       <div class="easyui-panel" fit="true" border="false" title="为角色赋权"
