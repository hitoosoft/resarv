...
<body class="easyui-layout">
  <div region="center" border="false">
    <form id="usr_formUsrModify" columns='2' class="easyui-form">
      ...
      <input id="usr_OrgComboTreeUsrModify" title="所属机构"  name="orgID" class="easyui-combotree" required="true" disabled="disabled" readonly/>
      <input id="usr_winAddUsr_usrTypCombobox" title="人员类别" syscode="USRTYP" name="usrTyp" class="easyui-combobox" panelHeight="auto" required="true" disabled="disabled" readonly/>
...
$(function(){
  ...
  if(usrID!=""){
    hitooctrl.eamsOperPost("${app}/sys/usr/queryUsrByID.do",{usrID:usrID},function(paraMap){
...
function btnUsrModifySaveClick(obj){
  ...
  hitooctrl.eamsOperPost("${app}/sys/usr/modifyUsr.do",$("#usr_formUsrModify").form("getData"),function(paraMap){
