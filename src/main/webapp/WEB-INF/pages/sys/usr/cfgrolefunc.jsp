...
<script type="text/javascript">
	...
	function removeRoleFromUser(usrID ,roleID){
		...
		param.oper="remove";
		hitooctrl.eamsOperPost("${app}/sys/usr/changeRoleForUsr.do",param,function(paraMap){
			reloadDg();
			refreshAuthorityTree(usrID);
		});
	}
	...
	function referRoleFunc(obj){
		hitooctrl.addIndexTab('EAMS00SYS010200', '${app}/sys/usr/forwardUsrindex.do?referUsrID=' + usrID+'&referUsrNam='+usrNam, "参照授权", "icon-group-link"); 
	}
