...
var orgID = "${param.orgID}";
  ...
  $(function(){
    ...
    $('#usr_OrgComboTreeUsrAdd').combotree({
      ...
      if (orgID==null||orgID== 'EAMSROOT') {
          $('#usr_OrgComboTreeUsrAdd').combotree('setValue', '');
        } else {
          $('#usr_OrgComboTreeUsrAdd').combotree('setValue', orgID);
        }
      }
    });
    $("#usr_winAddUsr_usrTypCombobox").combobox("setValue",'1');
  ...
  function btnUsrAddSaveClick(obj) {
    ...
    hitooctrl.eamsOperPost("${app}/sys/usr/addUsr.do",$("#usr_formUsrAdd").form("getData"),function(paraMap){
