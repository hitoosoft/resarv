...
<body class="easyui-layout">
	<div region="west"  style="width:500px;" border="false">
			...
			<div id="dicTb" style="padding: 0px; height: auto;">
				...
				<div class='perm-panel'>
					<a class="easyui-linkbutton" id='EAMSSYS00060002' iconCls="icon-add" onclick="addOrEditDic(0)" plain="true" >新增</a>
					<a class="easyui-linkbutton" id='EAMSSYS00060003' iconCls="icon-edit" onclick="addOrEditDic(1)" plain="true" >修改</a>
					<a class="easyui-linkbutton" id='EAMSSYS00060004' iconCls="icon-remove-edit" onclick="removeDic()" plain="true" >删除</a>
	...
	<div region="center" border="false" class="htborder-left">
		...
		<table>
				<tr><td>
			<div class='perm-panel'>
				<a class="easyui-linkbutton" id='EAMSSYS00060005' iconCls="icon-add" onclick="editSubDic(0)" plain="true" >新增</a>
				<a class="easyui-linkbutton" id='EAMSSYS00060006' iconCls="icon-edit" onclick="editSubDic(1)" plain="true" >修改</a>
				<a class="easyui-linkbutton" id='EAMSSYS00060007' iconCls="icon-remove-edit" onclick="removeDicDtl()" plain="true" >删除</a>
				<a class="easyui-linkbutton" id='EAMSSYS00060008' iconCls="icon-reload" onclick="reloadDicCache()" plain="true" >刷新缓存</a>
			</div>
			</td></tr>
		</table>
		</div> 	
...
<script type="text/javascript">
	...
	function reloadDicCache(){
		...
		hitooctrl.eamsOperPost(url, {}, function (){
