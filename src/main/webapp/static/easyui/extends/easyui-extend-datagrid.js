(function(){
	...
	$.extend($.fn.datagrid.methods,{
		...
		initData:function(jq,param){
			return jq.each(function(){
				...
				$dg.datagrid({
					pagination:true,
					url:hitooctrl.webprojectname+"/initDatagridInfoWithPage.do?queryType="+queryType,
					fitColumns:true
				});
			});
		}
	...
	function setGridData(pager,$dg,paramStr){
		...
		if(!sn)sn="";
		var url = hitooctrl.webprojectname+"/queryDatagridInfoWithPage.do?page="+pageOption.pageNumber+"&rows="+pageOption.pageSize+
