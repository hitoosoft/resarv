...
(function ($) {
    ...
    $.fn.abigimage = function(options) {
        ...
        var rotateRightSrc = hitooctrl.webprojectname+'/static/images/abigimg/route_right.png?v=2';
        var rotateLeftSrc = hitooctrl.webprojectname+'/static/images/abigimg/route_left.png?v=2';
        if (typeof rotateSave != 'undefined' && rotateSave == true) {
        	rotateRightSrc = hitooctrl.webprojectname+'/static/images/abigimg/route_rightc.png?v=1';
            rotateLeftSrc = hitooctrl.webprojectname+'/static/images/abigimg/route_leftc.png?v=1';
        } else {
        	rotateSave = false;
        }
    	...
    	this.prevpage   = elementAppendTo('img', {"src":hitooctrl.webprojectname+"/static/images/abigimg/prevpage.png", 'title':'上一张'}, opts.toolbarDivImgCSS, this.toolbarbox);
    	this.nextpage   = elementAppendTo('img', {"src":hitooctrl.webprojectname+"/static/images/abigimg/nextpage.png", 'title':'下一张'}, opts.toolbarDivImgCSS, this.toolbarbox);
    	this.zoomin     = elementAppendTo('img', {"src":hitooctrl.webprojectname+"/static/images/abigimg/zoomin.png", 'title':'放大'}, opts.toolbarDivImgCSS, this.toolbarbox);
    	this.zoominit   = elementAppendTo('img', {"src":hitooctrl.webprojectname+"/static/images/abigimg/zoominit.png", 'title':'还原'}, opts.toolbarDivImgCSS, this.toolbarbox);
    	this.zoomout    = elementAppendTo('img', {"src":hitooctrl.webprojectname+"/static/images/abigimg/zoomout.png", 'title':'缩小'}, opts.toolbarDivImgCSS, this.toolbarbox);
    	this.close      = elementAppendTo('img', {"src":hitooctrl.webprojectname+"/static/images/abigimg/close.png", 'title':'关闭'}, opts.closeCSS,this.layout);
    ...
    $.fn.abigimage.defaults = {
        ...
        inverse:            {"src":hitooctrl.webprojectname+"/static/images/abigimg/route_left.png"},
        clockwise:          {"src":hitooctrl.webprojectname+"/static/images/abigimg/route_right.png"},
        ...
        boxAttrs:           {},
        bodyAttrs:          {},
        prevBtnAttrs:       {"src":hitooctrl.webprojectname+"/static/images/abigimg/prevpage.png"},
        nextBtnAttrs:       {"src":hitooctrl.webprojectname+"/static/images/abigimg/nextpage.png"},
        closeBtnAttrs:      {"src":hitooctrl.webprojectname+"/static/images/abigimg/close.png"},
        imgAttrs:           {},
        imgNextAttrs:       {},
        imgPrevAttrs:       {},
        topAttrs:           {},
